...
//    public List<ResultStatistics> finishStatistics(String gameId) {
//        @SuppressWarnings("unchecked")
//        var list = (LinkedList<Question>) cache().get(gameId, LinkedList.class);
//
//        if (list == null) {
...
//            }
//            int percentage = (correctCount.get() * 100) / totalQuestions;
//            return new ResultStatistics(correctCount.get(), percentage);
//        }).toList();
//    }
}
